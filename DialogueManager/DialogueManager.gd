...
@export var current_fruit = ""
var game_context = {"location_outside": 0, "total_halfSauce": 0, "total_fullSauce": 0, "total_smallSauce": 0, "player_healthy": 0, "hunger_full": 0, "weather_clear": 0}
